  ...
  const products = [
    {
      ...
      isFeatured: true,
      images: ['https://via.placeholder.com/600x600/000000/FFFFFF/?text=Headphones'],
    },
    {
      name: 'Cotton T-Shirt',
      slug: 'cotton-t-shirt',
      ...
      isFeatured: true,
      images: ['https://via.placeholder.com/600x600/CCCCCC/333333/?text=T-Shirt'],
    },
    {
      name: 'Smart Watch',
      slug: 'smart-watch',
      ...
      categoryId: createdCategories[0].id,
      isFeatured: true,
      images: ['https://via.placeholder.com/600x600/333333/FFFFFF/?text=Smart+Watch'],
    },
    {
      name: 'Yoga Mat',
      slug: 'yoga-mat',
      ...
      images: ['https://via.placeholder.com/600x600/4CAF50/FFFFFF/?text=Yoga+Mat'],
    },
    {
      name: 'Coffee Maker',
      slug: 'coffee-maker',
      ...
      images: ['https://via.placeholder.com/600x600/8B4513/FFFFFF/?text=Coffee+Maker'],
    },
    {
      name: 'Running Shoes',
      slug: 'running-shoes',
      ...
      categoryId: createdCategories[4].id,
      isFeatured: true,
      images: ['https://via.placeholder.com/600x600/2196F3/FFFFFF/?text=Running+Shoes'],
    },
    {
      ...
      images: ['https://via.placeholder.com/600x600/9C27B0/FFFFFF/?text=Novel'],
    },
    {
      name: 'Desk Lamp',
      slug: 'desk-lamp',
      ...
      stock: 45,
      categoryId: createdCategories[2].id,
      images: ['https://via.placeholder.com/600x600/FF9800/333333/?text=Desk+Lamp'],
    },
  ];
